...
urlpatterns = [
    ...
    path('modify_room/<int:page>', views.modify_room, name='modify_room'),
    path('modify_certain_room/<int:room_id>', views.modify_certain_room, name='modify_certain_room'),
    ...
    path('view_appliaction/', views.view_application, name='view_my_application'),
