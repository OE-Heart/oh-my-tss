...
urlpatterns = [
    ...
    path('modify_room/<int:room_id>', views.modify_certain_room, name='modify_certain_room'),
    ...
    path('handle_application/<int:application_id>', views.handle_certain_application, name='handle_certain_application'),
