...
urlpatterns = [
    ...
    path('class_selection/', include('class_selection.urls'), name="在线选课"),
    path('grade_mgt/',include('grade_mgt.urls'),name="成绩管理"),
    path('resource_share/',include('resource_share.urls'),name="资源共享")
